...
| UT-19 | `test_format_markdown_native`                                          | `text_processing/formatter` | 表組み垂直整列、見出し空行自動挿入、連続空行圧縮                     | **Pass** |
| UT-20 | `test_format_markdown_native_front_matter_and_code_block_protection`   | `text_processing/formatter` | フロントマター・コードブロック内空行の完全保護                       | **Pass** |
| UT-21 | `test_render_markdown_html_native`                                     | `text_processing/html`      | `syntect` 構文ハイライト付き HTML 事前生成                           | **Pass** |
| UT-22 | `test_export_html_full_native`                                         | `text_processing/html`      | 完全スタンドアロン HTML エクスポートドキュメント生成                 | **Pass** |
