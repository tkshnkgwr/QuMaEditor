...
| UT-19 | `test_format_markdown_native`                                          | `text_processing/formatter` | GFM table alignment, heading spacing, blank line collapsing          | **Pass** |
| UT-20 | `test_format_markdown_native_front_matter_and_code_block_protection`   | `text_processing/formatter` | Code block and front matter preservation                             | **Pass** |
| UT-21 | `test_render_markdown_html_native`                                     | `text_processing/html`      | Pre-rendering HTML with syntect syntax highlighting                  | **Pass** |
| UT-22 | `test_export_html_full_native`                                         | `text_processing/html`      | Standalone HTML document export generation                           | **Pass** |
